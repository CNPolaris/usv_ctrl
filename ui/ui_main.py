...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.client_ip_text.setGeometry(QRect(90, 15, 111, 31))
        ...
        self.client_port_text.setGeometry(QRect(240, 14, 81, 31))
        ...
        self.client_serial_port = QTextEdit(self.groupBox_2)
        self.client_serial_port.setObjectName(u"client_serial_port")
        self.client_serial_port.setEnabled(True)
        self.client_serial_port.setGeometry(QRect(90, 14, 111, 31))
