...
class RRT(object):
    ...
    def __init__(self, start, goal, bounds, obstacle_coords) -> None:
        self.bounds = bounds
        self.start = start
        self.goal = goal
    ...
    def gen_grid(self) -> None:
        ...
        """
        self.grids, self.params = area_to_grid(self.bounds)
        ...
        self.grid_array = gen_grids_array(self.grids, self.params,
